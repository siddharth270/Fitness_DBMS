...
CREATE TABLE Appointment (
    ...
    status VARCHAR(20) NOT NULL,
    FOREIGN KEY (trainer_id) REFERENCES Trainer(trainer_id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (member_id) REFERENCES `Member`(member_id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE Plan_Exercise (
    ...
    FOREIGN KEY (plan_id) REFERENCES Workout_Plan(plan_id) ON UPDATE CASCADE ON DELETE CASCADE,
